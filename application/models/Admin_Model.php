...
class Admin_Model extends CI_Model
{
	...
	public function updatecalon($nisn, $no, $nama, $visimisi, $photo)
	{
		$save		= $this->db->query("UPDATE tb_pilihan SET no='$no', nama='$nama', visimisi='$visimisi', photo='$photo' WHERE nisn='$nisn'");
		return $save;
	}
