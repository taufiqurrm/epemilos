...
<body style="background-image:url('<?php echo base_url(); ?>asset/img/background.png'); background-size: 100%; width: 100%; background-repeat: no-repeat">
    <div class="ch-container">
        <br><br>
        <div class="row col-md-4 center" style="background-color: white; border-radius: 10px; padding:20px;">
                ...
                <form class="form-horizontal" action="index.html" method="post">
                    <fieldset>
                        ...
                        <p class="center col-md-5" style="width:150px;">
                            <button type="submit" class="btn btn-danger btn-lg"><span class="glyphicon glyphicon-log-in"></span>&nbsp;&nbsp;<b>LOGIN</b></button>
                        </p>
                    </fieldset>
                </form>
            </div>
