...
<body style="background-image:url('<?php echo base_url(); ?>asset/img/background.png'); background-size: 100%; width: 100%; background-repeat: repeat">
	<div class="ch-container">
		<br><br>
		<div class="row col-md-4 center card" style="background-color: white; border-radius: 10px; padding:20px;">
			<div class="row-md-5 center login-box">
				...
				<form class="form-horizontal" action="index.html" method="post">
					<fieldset>
						...
						<p class="center col-md-5" style="width:150px;">
							<button type="submit" class="btn btn-success btn-lg"><span class="glyphicon glyphicon-log-in"></span>&nbsp;&nbsp;<b>LOGIN</b></button>
						</p>
